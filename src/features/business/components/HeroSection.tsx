...
export default function HeroSection({ onBookCall }: HeroSectionProps) {
  return (
    <section className="text-white relative w-full h-[85dvh] min-h-[300px] flex flex-col items-center justify-end pb-14 px-2">
      ...
      {/* CTA */}
      <section className="text-center w-full max-w-xl flex portrait:flex-col landscape:flex-row justify-center items-center gap-4 mt-10">
        <BookCallButton onClick={onBookCall} />
        <div className="flex flex-col landscape:items-start portrait:items-center justify-center gap-0.5 text-[12px] w-full">

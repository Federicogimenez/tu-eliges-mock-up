...
export default function ButtonPrimary (
  ...
  return (
    <a href={src} 
      target="_blank" 
      className={`group block text-white relative cursor-pointer w-full  rounded-full sm:text-xl md:text-xl font-semibold hover:font-bold px-8 py-3 text-center border-2 border-white shadow-lg shadow-black/50 overflow-hidden duration-500 hover:-translate-y-1 ${customStyle}`}>

...
- **Savings calculator:** modal global (botón verde flotante), 19 subcategorías; variante B2B oculta el costo de membresía. *Ojo: el botón flotante está comentado en `Main.tsx` en el working tree — decisión sin ratificar, ver `ideas.md`.*
